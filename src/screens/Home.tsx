 ...
 *
 * Filled outlines rather than strokes, and drawn for 18px — the size the
 * tiles render them at. The traced edges are a staircase of sub-pixel steps,
 * which is invisible here but would show if one were ever blown up, so scale
 * these up only after re-exporting from the source artwork. The fill is
