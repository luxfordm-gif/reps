...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    title: "What's new",
    bullets: [
      "Workout days open with the day's photo and a start button",
      'One Edit button reorders the whole workout at once',
    ],
  },
  {
  ...
  },
  {
    ...
    title: "What's new",
    bullets: [
      'Machine brands now sit under the exercise name',
      'Adding an exercise has its own field for the brand',
    ],
  },
  {
